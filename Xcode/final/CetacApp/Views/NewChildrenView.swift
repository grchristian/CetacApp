...
//  CetacApp
//
//  Created by Equipo 1 on 08/10/21.
//
...
struct NewChildrenView: View {
    ...
    func postData(parameters: [String: Any]) {
        let urlString = "https://cetac.hernandez.dev/createChildren"
    ...
    var trailing: some View {
        Button(action: {
            if nombre != "" {
                let parameters: [String: Any] = ["nombre": nombre, "sexo": sexo, "fechaDeNacimiento": dateFormatter.string(from: fechaDeNacimiento), "parent": parent, "token": getToken()]
