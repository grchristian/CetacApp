...
struct NewSessionView: View {
    ...
    func postData(parameters: [String: Any]) {
        let urlString = "https://cetac.hernandez.dev/createSession.php"
    ...
    var trailing: some View {
        Button(action: {
            if evaluacion != "" && cuota != "" {
                let parameters: [String: Any] = ["usuario": id, "tanatologo": 1, "fecha": dateFormatter.string(from: fecha), "motivo": selectedMotivo, "intervencion": selectedIntervencion, "herramienta": selectedHerramienta, "evaluacion": evaluacion, "cuota": cuota]
